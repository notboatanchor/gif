...
// Parsed successfully → the hostname allowlist to pass to the SDK's
// validateOriginHeader(). Parsed unsuccessfully → a human-readable problem
// string naming the offending configuration, safe to place directly in a
// console.error line or a startup-refusal Error message (mirrors
// identity-secret.ts's identitySecretProblem() contract).
...
export function parseAllowedOrigins(raw: string | undefined): ParseAllowedOriginsResult {
